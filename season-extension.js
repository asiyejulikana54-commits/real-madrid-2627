...
const CHRONOLOGY=Object.freeze({version:(base.chronology?.version||3)+1,source:'canonical+extensions',order:Object.freeze(MATCHES.map(m=>m.id)),labels:Object.freeze(MATCHES.map(m=>m.label)),note:'Cronología completa tras incorporar las entradas validadas de season-input.js.'});
