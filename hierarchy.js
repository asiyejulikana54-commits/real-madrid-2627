...
function renderHierarchy(){
  ...
  <div class="card h-method"><div><div class="eyebrow">ÍNDICE DE JERARQUÍA</div><h3>45% Power · 20% minutos · 20% forma · 15% nuestras decisiones</h3><p>Power, minutos y forma proceden de la arquitectura oficial. La serie temporal dispone de ${coverage?.complete3||0} apariciones 3/3 y ${coverage?.partial2||0} apariciones 2+SC.</p></div><div><b>Una única forma</b><span>La forma reciente usa la misma nota multifuente que Evolución, Radar e Inteligencia.</span><small>Si falta forma, su peso se redistribuye entre las señales disponibles.</small></div></div>
  ...
  <div class="h-integrity"><b>Cómo leer el mapa</b><span>“Titular claro” exige margen sobre el primer jugador que quedaría fuera y presencia en nuestras referencias de XI. La forma usa exclusivamente la nota oficial de season-data.js.</span></div>`;
}
