const CACHE_VERSION='rm2627-static-v11';
const CORE_PATHS=['','index.html','style.css','community.css','ux-cleanup.css','personal-hub.css','playerhub.css','player-experience.css','site-guide.css','personal-home.css','matchday.css','compare-pro.css','stats-pro.css','app.js','season-data.js','minute-sync.js','community.js','personal-hub.js','personal-nav.js','playerhub.js','player-experience.js','site-guide.js','personal-home.js','matchday.js','compare-pro.js','stats-pro.js','pwa.css','pwa.js','manifest.webmanifest','app-icon.svg'];
