...
function render(){
  ...
  <section class="ux-lower-section ux-lower-now"><div class="ux-lower-head"><div><span>AHORA MISMO</span><h2>Quién está marcando la temporada.</h2></div><p>Rendimiento puro, sin llenar Inicio de tablas.</p></div><div class="ux-lower-grid">
  ...
  root.querySelectorAll('[data-lower-go]').forEach(btn=>btn.addEventListener('click',()=>go(btn.dataset.lowerGo)));
