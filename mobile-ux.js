...
function loadHomeLower(){if(document.querySelector('script[data-home-lower-redesign]'))return;const s=document.createElement('script');s.src='home-lower-redesign.js?v=2';s.dataset.homeLowerRedesign='1';document.body.appendChild(s)}
