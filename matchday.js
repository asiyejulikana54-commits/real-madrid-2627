...
function ensureSeasonExtension(){if(seasonMatchReady())return Promise.resolve(true);if(seasonLoader)return seasonLoader;seasonLoader=loadScriptOnce('season-input.js?v=4').then(()=>loadScriptOnce('season-extension.js?v=8')).then(()=>{setTimeout(render,0);return seasonMatchReady()});return seasonLoader}
