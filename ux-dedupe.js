...
function addMvpHome(){
  ...
  let card=document.getElementById('uxHomeMvp');if(!card){card=document.createElement('button');card.id='uxHomeMvp';card.type='button';card.className='ux-home-mvp';routes.insertAdjacentElement('afterend',card)}
