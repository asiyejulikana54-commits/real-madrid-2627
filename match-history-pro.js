...
function matchAnalysis(m){
  if(m?.id!=='elche')return '';
  return `<div class="mhp-strict-change"><div style="grid-column:1/-1"><span>ANÁLISIS DEL PARTIDO</span><h3>Elche 2-3 Real Madrid · dos caras muy diferentes</h3><p>El Real Madrid mostró dos caras muy diferentes en Elche. En la primera parte fue vertical, agresivo y generó numerosas situaciones de peligro. Tchouaméni dio equilibrio, Valverde encontró espacios para avanzar y Güler volvió a ser el principal foco creativo, mientras Diomande firmó su actuación más influyente hasta ahora. El 0-2 al descanso pudo incluso quedarse corto.</p><p style="margin-top:8px">El problema volvió a aparecer tras el descanso. El Madrid perdió intensidad y, sobre todo, control del partido. El Elche fue creciendo hasta igualar un encuentro que parecía decidido. Con el 2-2, Mourinho arriesgó con los cambios y el talento individual terminó resolviendo: Bellingham inició la acción, Mbappé asistió y Carlos Espí apareció en el añadido para marcar el 2-3.</p><p style="margin-top:8px"><strong style="color:var(--text)">Conclusión:</strong> tres puntos importantes, pero otro aviso. El Madrid genera mucho cuando acelera, aunque todavía necesita aprender a controlar los partidos cuando tiene ventaja.</p></div></div>`
}
