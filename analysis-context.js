...
function install(){
  ...
  syncStats(true);loadEngagementLoop();loadEngagementRewards();loadQuickPicks();loadFavoriteWatch();loadActivityCenter();loadDeepLinks();loadSharedEntry();loadMomentumPro();loadPostXiCenter();loadSimpleMode();
