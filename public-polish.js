...
function loadEngagement(){
  if(!document.querySelector('link[data-public-engagement]')){const link=document.createElement('link');link.rel='stylesheet';link.href='public-engagement.css?v=2';link.dataset.publicEngagement='1';document.head.appendChild(link)}
  if(!document.querySelector('script[data-public-engagement]')){const script=document.createElement('script');script.src='public-engagement.js?v=2';script.dataset.publicEngagement='1';document.body.appendChild(script)}
}
