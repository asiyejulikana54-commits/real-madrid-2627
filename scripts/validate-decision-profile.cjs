...
for(const marker of ['PERFIL DE DECISIONES · AUDITADO','Ruptura con referencia','Tus cambios ganan','Al mantener referencia','POR LÍNEA','RMDecisionProfile','strictRecords','!r.snapshotLate','attempts<100'])if(!js.includes(marker))failures.push(`decision-profile.js: falta ${marker}`);
...
for(const marker of ['loadDecisionProfile','decision-profile.js?v=2','decision-profile.css?v=1','RMDecisionProfile?.render'])if(!nav.includes(marker))failures.push(`personal-nav.js: falta ${marker}`);
