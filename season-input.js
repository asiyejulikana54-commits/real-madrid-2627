...
window.RMSeasonMatchEntries=Object.freeze([
  ...
  Object.freeze({
    ...
    duration:90,
    final:true,
    substitutionAdjustment:38,
    sourceNote:'Capturas directas de SofaScore, FotMob y StatMuse · 20-09-2026. Huijsen se trata como sustitución al 52\' a efectos de validación de minutos; sus minutos individuales reales permanecen en 52.',
    players:Object.freeze({
      'Courtois':Object.freeze({minutes:90,sofascore:8.6,fotmob:7.4,statmuse:6.5}),
      'Dumfries':Object.freeze({minutes:90,sofascore:6.5,fotmob:6.6,statmuse:6.8}),
      'Konaté':Object.freeze({minutes:90,sofascore:7.5,fotmob:7.3,statmuse:6.9}),
      'Huijsen':Object.freeze({minutes:52,sofascore:6.2,fotmob:5.5,statmuse:5.0,note:'Salida en el 52; tratada como sustitución para el control de minutos.'}),
      'Cucurella':Object.freeze({minutes:90,sofascore:6.5,fotmob:6.8,statmuse:6.8}),
      'Tchouaméni':Object.freeze({minutes:71,sofascore:6.8,fotmob:6.8,statmuse:7.1}),
      'Valverde':Object.freeze({minutes:90,sofascore:6.9,fotmob:6.7,statmuse:7.1}),
      'Arda Güler':Object.freeze({minutes:54,sofascore:6.9,fotmob:6.5,statmuse:6.4}),
      'Vini Jr.':Object.freeze({minutes:54,sofascore:6.6,fotmob:6.5,statmuse:5.4}),
      'Bellingham':Object.freeze({minutes:82,sofascore:7.1,fotmob:7.9,statmuse:7.2}),
      'Mbappé':Object.freeze({minutes:90,sofascore:6.9,fotmob:6.4,statmuse:6.3}),
